...
responseInterceptor(Request request, Response response) {
  ...
  logger.i(message);
  //setiap hasil request sukses maka akan di save di GetStorage dengan
  ///alamat api sebagainya keynya dan response API sebagai valuenya
  ///sehingga kalau request gagal kita bisa ambil dari GetStorage
